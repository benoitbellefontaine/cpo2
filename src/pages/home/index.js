...
const letters = [
  ...
  {letter:'P',key:2, color:'#3da300'},
  {letter:'O',key:3, color:'#45c8d9'},
];

const mottoF = [...'BÂTIR ET RÉNOVER DES ENTREPRISES !'];
const mottoE = [...'A BLUEPRINT TO SUCCESS !'];
...
const Home = ({ style, show, language }) => (
  <animated.div className="mainRoute" style={{ ...style, 
    //background: `#e8c8c8`,
    height:'100%',
    background: 'linear-gradient(#3da300, #222)' 
    }}>
