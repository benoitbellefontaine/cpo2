export default
  {
    ...
    "children": [
        ...
        { "nom": "Excellence" ,"name": "Excellence" ,
            ...
            "children": [
                { "id": 27,"nom": "planification stratégique","name": "strategic planning","desc":"strategic planning","color":'rgb(148,103,189)',"selected":false },
                { "id": 28,"nom": "plan de relève","name": "succession planning","desc":"succession planning","color":'rgb(148,103,189)',"selected":false },
                { "id": 29,"nom": "tableau de bord (scorecard)","name": "scorecard","desc":"scorecard","color":'rgb(148,103,189)',"selected":false },
                { "id": 30,"nom": "analyse de la chaine des valeurs","name": "value chain optimisation","desc":"value chain optimisation","color":'rgb(148,103,189)',"selected":false },
                { "id": 31,"nom": "rigueur & discipline","name": "rigor & discipline","desc":"rigor & discipline","color":'rgb(148,103,189)',"selected":false },
                { "id": 32,"nom": "plans quinquennaux","name": "five-year plans","desc":"five-year plans","color":'rgb(148,103,189)',"selected":false },
            ]
        },
        { "nom": "Redressement" ,"name": "Reengineering" ,
            ...
            "children": [
                { "id": 33,"nom": "respirateur artificiel", "name": "life support","desc":"respirateur artificiel", "color":'rgb(140,86,75)',"selected":false },
                { "id": 34,"nom": "consolidation de dettes","name": "debt consolidation","desc":"consolidation de dettes", "color":'rgb(140,86,75)',"selected":false },
                { "id": 35,"nom": "recherche de nouveaux investisseurs","name": "search for new investors","desc":"recherche de nouveaux investisseurs", "color":'rgb(140,86,75)',"selected":false },
                { "id": 36,"nom": "réingénierie","name": "reengineering","desc":"réingénierie", "color":'rgb(140,86,75)',"selected":false },
                { "id": 37,"nom": "plan de revitalisation","name": "revitalization plan","desc":"plan de revitalisation", "color":'rgb(140,86,75)',"selected":false },
                { "id": 38,"nom": "refinancement","name": "refinancing","desc":"refinancement", "color":'rgb(140,86,75)',"selected":false },
            ]
        },
    ]
}
